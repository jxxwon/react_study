                ...
                <ComnCodMgrTableStyled>
                    <tbody>
                        <tr>
                            <th>그룹 코드 id *</th>
                            <td>
                                <input type="text" name="grp_cod" required onChange={(e) => {setComnCod({...comnCod, grp_cod: e.target.value})}} defaultValue={detailComnCod?.grp_cod}></input>
                            </td>
                            <th>그룹 코드 명 *</th>
                            <td>
                                <input type="text" name="grp_cod_nm" onChange={(e) => {setComnCod({...comnCod, grp_cod_nm: e.target.value})}} defaultValue={detailComnCod?.grp_cod_nm}></input>
                            </td>
                        </tr>
                        <tr>
                            <th>코드 설명</th>
                            <td colSpan={3}>
                                <input type="text" onChange={(e) => {setComnCod({...comnCod, grp_cod_eplti: e.target.value})}} defaultValue={detailComnCod?.grp_cod_eplti}></input>
                            </td>
                        </tr>
                        <tr>
                            <th>사용 유무 *</th>
                            <td colSpan={3}>
                                <input type="radio" name="useYn" value={'Y'} onChange={(e) => setComnCod({...comnCod, grp_use_poa: e.target.value})} checked={detailComnCod?.use_poa === 'Y'}></input>
                                사용
                                <input type="radio" name="useYn" value={'N'} onChange={(e) => setComnCod({...comnCod, grp_use_poa: e.target.value})} checked={detailComnCod?.use_poa === 'N'}></input>
                                미사용
                            </td>
                        </tr>
                    </tbody>
