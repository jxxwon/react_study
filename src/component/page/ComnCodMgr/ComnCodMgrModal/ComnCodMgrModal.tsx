...
import { IComnCod, IDetailResponse, IPostResponse } from "../../../../models/interface/ComnCodMgr/comnCodMgrModel";
...
export const ComnCodMgrModal: FC<IComnCodMgrModalProps> = ({ onPostSuccess, grpCod, setGrpCod }) => {
    ...
    // const [detailComnCod, setDetailComnCod] = useState<IComnGrpCodModel>(); //ComnCod가 있으니까 굳이 두 번 할 필요가 없음
