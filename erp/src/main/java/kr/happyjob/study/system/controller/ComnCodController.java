...
public class ComnCodController {
	...
	@ResponseBody
	public Map<String, Object> listComnGrpCodJson(Model model, @RequestBody Map<String, Object> paramMap, HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		...
		int currentPage = Integer.valueOf((String.valueOf(paramMap.get("currentPage"))));	// 현재 페이지 번호
		int pageSize = Integer.valueOf((String.valueOf(paramMap.get("pageSize"))));			// 페이지 사이즈
...
//		model.addAttribute("currentPageComnGrpCod",currentPage);
		...
		logger.info("+ End " + className + ".listComnGrpCodJson");
	...
	@ResponseBody
	public Map<String, Object> selectComnGrpCod (Model model, @RequestBody Map<String, Object> paramMap, HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
	...
	@ResponseBody
	public Map<String, Object> deleteComnGrpCod(Model model, @RequestBody Map<String, Object> paramMap, HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
...
공통 상세 코드 목록 조회*/
	@RequestMapping("listComnDtlCodJson.do")@ResponseBody
  public Map<String, Object> listComnDtlCodJson(Model model, @RequestBody Map<String, Object> paramMap,
	...
	@ResponseBody
	public Map<String, Object> selectComnDtlCod (Model model, @RequestBody Map<String, Object> paramMap, HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
